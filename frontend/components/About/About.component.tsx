  ...
  <section id="about" className={styles.about}>
    ...
    <div className={styles.row}>
      ...
      <div className={styles.content}>
        ...
        à proximité d'un lieu précis. L'application repose sur du requêtage de proximité basé sur Mongo DB ainsi que Leaflet JS pour la partie cartographie</p><br/>
